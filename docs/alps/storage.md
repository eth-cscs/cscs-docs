...
HPC storage is managed in separate clusters of nodes that host servers that manage the storage and the physical storage drives.
...
Capstor and Iopsstor are on the same Slingshot 11 network as the Alps.
