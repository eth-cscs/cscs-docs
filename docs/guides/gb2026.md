...
* Clariden is unavailable to regular user jobs during the reserved window **09:00-19:00 CEST**.
...
* **Scratch** is shared between Daint, Clariden, and Santis
* **Store/Project** filesystems are mounted
* **capstor**, **iopstor**, and **VAST** are mounted on Clariden during the Gordon Bell runs

For most workloads, **capstor** is the recommended choice.
### Storage

The same shared filesystems are available across Daint, Clariden, and Santis:

* **capsstor**, **iopsstor**, and **VAST** are mounted on Clariden during the Gordon Bell runs
* **Home** is shared between Daint, Clariden, and Santis
