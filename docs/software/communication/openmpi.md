...
!!! todo
    Above are the suggested environment variablesfrom the CE pull request.
...
We present some performance numbers for OpenMPI, obatained using the OSU benchmarks compiled in the above image.
