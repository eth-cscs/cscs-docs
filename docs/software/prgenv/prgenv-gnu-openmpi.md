...
=== "26.3"
    ...
    The key updates in version 26.3 compared to 25.12 are upgrading CUDA to version 13.1 and OpenMPI to version 5.0.10.
    ...
    ??? info "Packages exposed by the `default` and `modules` views"
        ...
        * [openmpi@5.0.10](https://packages.spack.io/package.html?name=openmpi)
