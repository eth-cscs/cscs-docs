...
!!! todo "Discontinued service"
    The Long Term Storage (LTS) service no longer supports the ingestion of new digital objects. Nevertheless, it will remain operational to ensure the long-term preservation and continued accessibility of all previously deposited digital objects.
