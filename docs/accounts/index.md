...
A single account is used to access various services and systems at CSCS.
To get an account you will need to be invited by the principal investigator (PI) of an active project at CSCS.

!!! note "Getting a project at CSCS for PIs"
    In order to get an account at CSCS, or to request access for the members of your team, you first need to have a project at CSCS.
...
In this case, they can sign into the CSCS services using their home institution credentials instead of the CSCS username/password.
...
The number of external institutions that are allowed to link their accounts is limited and displayed on the login page.

Linking an external account can be done in the Profile section (upper-right corner) of your account page at [portal.cscs.ch](https://portal.cscs.ch).
