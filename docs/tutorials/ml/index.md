...
The [vLLM/SGLang on AMD GPUs tutorial][software-ml-vllm-sglang-amdgpus] provides a basic reference on how to setup vLLM/SGLang to serve a LLM on a single or multi node setup, using official containers via CE.
