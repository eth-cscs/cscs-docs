...
The [vLLM on AMD GPUs tutorial][software-ml-vllm-amdgpus] provides a basic reference on how to setup vLLM to serve a LLM on a single or multi node setup, using official containers via CE.
